...
$(function() {
    ...
    $('.nav__link_donate__mob').on('click', function() {
      $('.modalContainer-2').css('display', 'flex')
    })
    $('#closePopup').on('click', function() {
      $('.modalContainer-2').css('display', 'none')
    })
...
$( document ).ready(function() {
  $('.trigger').click(function() {
     $('.isUnregUser').toggleClass('isModaled');
     $('.modalSystem').toggleClass('visibleModal');
     return false;
  });
});
...
$( document ).ready(function() {
  $('.trigger-two').click(function() {
     $('.isUnregUser').toggleClass('isModaled-2');
     $('.modalPayment').toggleClass('visibleModal-2');
     return false;
  });
});
